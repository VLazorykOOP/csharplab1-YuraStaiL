...
static double findAvgModule(double x, double y)
{
...
static bool isEndOnSeven(int number)
{
    return number % 10 == 7;
}

static bool task2Var5()
{
...
static string isPointIncluded(float x, float y)
{
...
static string getFullCardName(int suit, int card)
{
